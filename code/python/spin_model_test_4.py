...
for i in range(1):
    ...
    test_path = "E:/CarData/train.csv" 
    #model_path = "G:/cuda/test1/new_spin_model/10_128_2_5_10_4950_" + str(i+1) + "0_use_train_spin_model.npz"
    model_path = "E:/cuda/test1/new_spin_model/10_10_2_5_10_4950_100_use_train_spin_model.npz"
    ...
    if(f1_score(t,p,average="macro") > maxaccuracy):
        maxaccuracy = f1_score(t,p,average="macro")
        maxnum = (i+1)*10
    #"""
    #"""
    plt.plot(range(N), test_bf, color="red", label="train_front_tire_slipangle", linestyle="-")
    #plt.plot(range(N), test_br, color="red", label="train_rear_tire_slipangle", linestyle="-")
    plt.plot(range(N), predict_bf, color="blue", label="predict_front_tire_slipangle", linestyle="--")
    #plt.plot(range(N), predict_br, color="blue", label="predict_rear_tire_slipangle", linestyle="--")
