...
model_path = "E:/cuda/test1/new_spin_model/" + str(in_size) + "_" + str(hidden_size) + "_" + str(out_size) + "_" + str(DELAY_SIZE) + "_" + str(BATCH_SIZE) + "_" + str(REPEAT_NUM) + "_" + str(DATA_NUM) + "_" + str(DATA_REPEAT) + "_spin_model.npz"
...
for i in range(57):
    ...
    for row in f:
        ...
        test_t.append(abs(float(row[12])))
